                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div className="process_box type_four color_two">
                                <div className="icon trans">
                                    <img src="/assets/images/chipMaker/process/1.png" className="img-fluid" alt="img" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div className="process_box type_four color_two">
                                <div className="icon trans">
                                    <img src="/assets/images/chipMaker/process/2.png" className="img-fluid" alt="img" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div className="process_box type_four">
                                <div className="icon trans">
                                    <img src="/assets/images/chipMaker/process/3.png" className="img-fluid" alt="img" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <div className="process_box type_four">
                                <div className="icon trans">
                                    <img src="/assets/images/chipMaker/process/4.png" className="img-fluid" alt="img" />
