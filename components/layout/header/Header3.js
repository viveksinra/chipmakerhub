                                    ...
                                    <div className="col-lg-3 width_50">
                                        <div className="logo_box">
                                            <Link href="/" className="logo navbar-brand">
                                                <img src="/assets/images/Logo-green.png" alt="ChipMakersHub" className="logo_default" />
                                            </Link>
                                        </div>
                                    </div>
                            ...
                            <div className="large-container">
                                ...
                                <div className="row">
                                    <div className="col-lg-3 col-md-3 col-sm-12">
                                        <Link href="/" className="logo navbar-brand">
                                            <img src="/assets/images/logo-white.svg" alt="ChipMakersHub " className="logo_default" />
                                        </Link>
